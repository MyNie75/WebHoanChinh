...
<link href="<c:url value="/theme/css/bootstrap.min.css"/>"
	rel="stylesheet">
<!-- bootstrap theme -->
<link href="<c:url value="/theme/css/bootstrap-theme.css"/>"
	rel="stylesheet">
<!--external css-->
<!-- font icon -->
<link href="<c:url value="/theme/css/elegant-icons-style.css"/>"
	rel="stylesheet" />
<link href="<c:url value="/theme/css/font-awesome.min.css"/>"
	rel="stylesheet" />
<!-- full calendar css-->
<link
	href="<c:url value="/theme/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css"/>"
	rel="stylesheet">
<link
	href="<c:url value="/theme/assets/fullcalendar/fullcalendar/fullcalendar.css"/>"
	rel="stylesheet">
<!-- easy pie chart-->
<link
	href="<c:url value="/theme/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css"/>"
	rel="stylesheet" type="text/css" media="screen">
<!-- owl carousel -->
<link rel="stylesheet"
	href="<c:url value="/theme/css/owl.carousel.css"/>" type="text/css">
<link href="<c:url value="/theme/css/jquery-jvectormap-1.2.2.css"/>"
	rel="stylesheet">
<!-- Custom styles -->
<link rel="stylesheet"
	href="<c:url value="/theme/css/fullcalendar.css"/>">
<link href="<c:url value="/theme/css/widgets.css"/>" rel="stylesheet">
<link href="<c:url value="/theme/css/style.css"/>" rel="stylesheet">
<link href="<c:url value="/theme/css/style-responsive.css"/>"
	rel="stylesheet">
<link href="<c:url value="/theme/css/xcharts.min.css"/>"
	rel=" stylesheet">
<link href="<c:url value="/theme/css/jquery-ui-1.10.4.min.css"/>"
	rel="stylesheet">
		...
		<aside>
			<div id="sidebar" class="nav-collapse " tabindex="5000"
				...
				<ul class="sidebar-menu">
					...
					<i class="icon_table"></i> <span>Tables</span> <span
							class="menu-arrow arrow_carrot-right"></span>
					</a>
						<ul class="sub">
